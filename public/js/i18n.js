...
const APP_TRANSLATIONS = {
  nl: {
    ...
    gpsbulk_locatie_toewijzen: "Locatie toewijzen",
    gpsbulk_groep_verwijder: "Groep verwijderen",
    gpsbulk_groep_verwijder_bevestig: "Deze hele groep ({n}) naar de prullenbak verplaatsen? De bestanden zijn herstelbaar via de systeem-prullenbak.",
    gpsbulk_groep_verwijderd: "naar prullenbak verplaatst",
    gpsbulk_klaar: "Alle groepen verwerkt!",
    gpsbulk_verwijder_fout: "Fout bij verwijderen. Probeer opnieuw.",
    ...
    dup_groepen: "groepen met duplicaten",
    dup_geen: "Geen duplicaten gevonden.",
    dup_zelfde: "hetzelfde bestand",
    dup_keuze_nodig: "hetzelfde bestand — kies welk exemplaar je behoudt",
    dup_origineel: "BEHOUDEN",
    opschoon_titel: "🧹 Ruimte vrijmaken",
    opschoon_vrij: "vrij te maken",
    opschoon_duplicaten: "📋 Duplicaten opruimen",
    opschoon_genegeerd: "🚫 Genegeerde verwijderen",
    opschoon_niets: "niets",
    opschoon_keuze_nodig: "duplicaatgroep(en) wachten nog op een keuze",
    selectie_start: "Selecteren",
    selectie_stop: "Stop selecteren",
    selectie_alle: "Alles op pagina",
    selectie_wis: "Wis selectie",
    selectie_negeer: "🚫 Negeer geselecteerde",
    selectie_meenemen: "✅ Toch meenemen",
    selectie_geselecteerd: "geselecteerd",
    selectie_niets: "Selecteer eerst een of meer foto's.",
    selectie_fout: "Bulk-actie mislukt",
    dup_kopie: "KOPIE",
    dup_maak_origineel: "Dit exemplaar behouden",
    dup_wacht: "Maak eerst een keuze hierboven om deze groep op te ruimen.",
    dup_wis_groep: "Duplicaten van deze groep wissen",
    dup_prioriteit: "⚙️ Prioriteit instellen",
    dup_gps_delen: "🌍 GPS automatisch delen",
    dup_wis_alle: "🗑️ Alle duplicaten naar prullenbak",
    dup_prio_titel: "⚙️ Waar bewaren we de originelen?",
    dup_prio_uitleg: "Zet je bronnen op volgorde. Staat hetzelfde bestand op meerdere bronnen, dan blijft het exemplaar op de hoogst geplaatste bron behouden. Bronnen die niet gerangschikt zijn, vragen om een handmatige keuze.",
    dup_prio_gerangschikt: "📌 Gerangschikt (hoogste eerst)",
    dup_prio_ongerangschikt: "Niet gerangschikt",
    dup_prio_bewaar: "💾 Bewaren & toepassen",
    dup_prio_geen: "Geen bronnen gerangschikt",
    dup_prio_verwijder: "Niet rangschikken",
    dup_prio_toevoegen: "Toevoegen aan rangschikking",
    export_titel: "📦 Export",
  ...
  en: {
    ...
    gpsbulk_locatie_toewijzen: "Assign location",
    gpsbulk_groep_verwijder: "Delete group",
    gpsbulk_groep_verwijder_bevestig: "Move this whole group ({n}) to the trash? The files can be restored from the system recycle bin.",
    gpsbulk_groep_verwijderd: "moved to trash",
    gpsbulk_klaar: "All groups processed!",
    gpsbulk_verwijder_fout: "Error while deleting. Please try again.",
    ...
    dup_groepen: "groups with duplicates",
    dup_geen: "No duplicates found.",
    dup_zelfde: "the same file",
    dup_keuze_nodig: "the same file — choose which copy to keep",
    dup_origineel: "KEPT",
    opschoon_titel: "🧹 Free up space",
    opschoon_vrij: "to free up",
    opschoon_duplicaten: "📋 Clean up duplicates",
    opschoon_genegeerd: "🚫 Delete ignored items",
    opschoon_niets: "nothing",
    opschoon_keuze_nodig: "duplicate group(s) still need a choice",
    selectie_start: "Select",
    selectie_stop: "Stop selecting",
    selectie_alle: "All on page",
    selectie_wis: "Clear selection",
    selectie_negeer: "🚫 Ignore selected",
    selectie_meenemen: "✅ Include again",
    selectie_geselecteerd: "selected",
    selectie_niets: "Select one or more photos first.",
    selectie_fout: "Bulk action failed",
    dup_kopie: "COPY",
    dup_maak_origineel: "Keep this one",
    dup_wacht: "Make a choice above first to clean up this group.",
    dup_wis_groep: "Delete duplicates of this group",
    dup_prioriteit: "⚙️ Set priority",
    dup_gps_delen: "🌍 Share GPS automatically",
    dup_wis_alle: "🗑️ Move all duplicates to trash",
    dup_prio_titel: "⚙️ Where do we keep the originals?",
    dup_prio_uitleg: "Rank your sources. If the same file exists on multiple sources, the copy on the highest-ranked source is kept. Unranked sources require a manual choice.",
    dup_prio_gerangschikt: "📌 Ranked (highest first)",
    dup_prio_ongerangschikt: "Not ranked",
    dup_prio_bewaar: "💾 Save & apply",
    dup_prio_geen: "No sources ranked",
    dup_prio_verwijder: "Do not rank",
    dup_prio_toevoegen: "Add to ranking",
    export_titel: "📦 Export",
  ...
  fr: {
    ...
    gpsbulk_locatie_toewijzen: "Assigner un lieu",
    gpsbulk_groep_verwijder: "Supprimer le groupe",
    gpsbulk_groep_verwijder_bevestig: "Déplacer tout ce groupe ({n}) vers la corbeille ? Les fichiers sont récupérables via la corbeille du système.",
    gpsbulk_groep_verwijderd: "déplacé vers la corbeille",
    gpsbulk_klaar: "Tous les groupes traités !",
    gpsbulk_verwijder_fout: "Erreur lors de la suppression. Réessayez.",
    ...
    dup_groepen: "groupes avec doublons",
    dup_geen: "Aucun doublon trouvé.",
    dup_zelfde: "le même fichier",
    dup_keuze_nodig: "le même fichier — choisissez l'exemplaire à conserver",
    dup_origineel: "CONSERVÉ",
    opschoon_titel: "🧹 Libérer de l'espace",
    opschoon_vrij: "à libérer",
    opschoon_duplicaten: "📋 Nettoyer les doublons",
    opschoon_genegeerd: "🚫 Supprimer les ignorés",
    opschoon_niets: "rien",
    opschoon_keuze_nodig: "groupe(s) de doublons en attente d'un choix",
    selectie_start: "Sélectionner",
    selectie_stop: "Arrêter la sélection",
    selectie_alle: "Tout sur la page",
    selectie_wis: "Effacer la sélection",
    selectie_negeer: "🚫 Ignorer la sélection",
    selectie_meenemen: "✅ Réintégrer",
    selectie_geselecteerd: "sélectionné(s)",
    selectie_niets: "Sélectionnez d'abord une ou plusieurs photos.",
    selectie_fout: "Échec de l'action groupée",
    dup_kopie: "COPIE",
    dup_maak_origineel: "Garder celui-ci",
    dup_wacht: "Faites d'abord un choix ci-dessus pour nettoyer ce groupe.",
    dup_wis_groep: "Supprimer les doublons de ce groupe",
    dup_prioriteit: "⚙️ Définir la priorité",
    dup_gps_delen: "🌍 Partager le GPS automatiquement",
    dup_wis_alle: "🗑️ Mettre tous les doublons à la corbeille",
    dup_prio_titel: "⚙️ Où conservons-nous les originaux ?",
    dup_prio_uitleg: "Classez vos sources. Si le même fichier existe sur plusieurs sources, l'exemplaire de la source la mieux classée est conservé. Les sources non classées nécessitent un choix manuel.",
    dup_prio_gerangschikt: "📌 Classées (plus haute d'abord)",
    dup_prio_ongerangschikt: "Non classées",
    dup_prio_bewaar: "💾 Enregistrer & appliquer",
    dup_prio_geen: "Aucune source classée",
    dup_prio_verwijder: "Ne pas classer",
    dup_prio_toevoegen: "Ajouter au classement",
    export_titel: "📦 Export",
  ...
  de: {
    ...
    gpsbulk_locatie_toewijzen: "Standort zuweisen",
    gpsbulk_groep_verwijder: "Gruppe löschen",
    gpsbulk_groep_verwijder_bevestig: "Diese ganze Gruppe ({n}) in den Papierkorb verschieben? Die Dateien sind über den System-Papierkorb wiederherstellbar.",
    gpsbulk_groep_verwijderd: "in den Papierkorb verschoben",
    gpsbulk_klaar: "Alle Gruppen verarbeitet!",
    gpsbulk_verwijder_fout: "Fehler beim Löschen. Bitte erneut versuchen.",
    ...
    dup_groepen: "Gruppen mit Duplikaten",
    dup_geen: "Keine Duplikate gefunden.",
    dup_zelfde: "dieselbe Datei",
    dup_keuze_nodig: "dieselbe Datei — wähle, welches Exemplar du behältst",
    dup_origineel: "BEHALTEN",
    opschoon_titel: "🧹 Speicher freigeben",
    opschoon_vrij: "freizugeben",
    opschoon_duplicaten: "📋 Duplikate aufräumen",
    opschoon_genegeerd: "🚫 Ignorierte löschen",
    opschoon_niets: "nichts",
    opschoon_keuze_nodig: "Duplikatgruppe(n) warten noch auf eine Auswahl",
    selectie_start: "Auswählen",
    selectie_stop: "Auswahl beenden",
    selectie_alle: "Alle auf der Seite",
    selectie_wis: "Auswahl aufheben",
    selectie_negeer: "🚫 Ausgewählte ignorieren",
    selectie_meenemen: "✅ Wieder einschließen",
    selectie_geselecteerd: "ausgewählt",
    selectie_niets: "Wählen Sie zuerst ein oder mehrere Fotos aus.",
    selectie_fout: "Massenaktion fehlgeschlagen",
    dup_kopie: "KOPIE",
    dup_maak_origineel: "Dieses behalten",
    dup_wacht: "Triff zuerst oben eine Wahl, um diese Gruppe aufzuräumen.",
    dup_wis_groep: "Duplikate dieser Gruppe löschen",
    dup_prioriteit: "⚙️ Priorität festlegen",
    dup_gps_delen: "🌍 GPS automatisch teilen",
    dup_wis_alle: "🗑️ Alle Duplikate in den Papierkorb",
    dup_prio_titel: "⚙️ Wo bewahren wir die Originale auf?",
    dup_prio_uitleg: "Ordne deine Quellen. Liegt dieselbe Datei auf mehreren Quellen, wird das Exemplar der höchsten Quelle behalten. Nicht eingestufte Quellen erfordern eine manuelle Wahl.",
    dup_prio_gerangschikt: "📌 Eingestuft (höchste zuerst)",
    dup_prio_ongerangschikt: "Nicht eingestuft",
    dup_prio_bewaar: "💾 Speichern & anwenden",
    dup_prio_geen: "Keine Quellen eingestuft",
    dup_prio_verwijder: "Nicht einstufen",
    dup_prio_toevoegen: "Zur Einstufung hinzufügen",
    export_titel: "📦 Export",
